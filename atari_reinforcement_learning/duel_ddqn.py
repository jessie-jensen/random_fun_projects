...
class QNetwork():
    ...
    def init_model(self):
        ...
        # actions_onehot = Lambda(K.one_hot, arguments={'num_classes':self.action_space}, output_shape=(None, self.action_space))(actions)
        ...
        advantage = Dense(self.action_space,
                        activation='linear'
                        )(fc2)

        q = QLayer()([value, advantage])

        self.model = keras.models.Model(input=[input_layer],
                        output=[q])            
